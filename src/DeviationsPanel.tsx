    ...
    <section className="entrada-section" aria-label="Desvios">
      ...
      {tab === 'deviations' ? (
        <ScheduleDateAdjustmentsPanel
          ...
          intro="Desvios de preenchimento (instalação, TOI, nota ou CSD corrigidos), medidor cadastrado no CSD errado, medidor agendado errado, data/horário de agendamento diferente do documento, medidor não agendado no ato da inspeção, documento de inspeção importado pelo laboratório, ausência de registro fotográfico e registro fotográfico com baixa qualidade."
