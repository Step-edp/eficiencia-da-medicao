          ...
          <section className="home-card area-screen-card">
            ...
            {selectedFieldTeamSection === 'Agendar' ? (
              ...
              <ScheduleDateAdjustmentsPanel
                ...
                intro="Desvios de preenchimento (instalação, TOI, nota ou CSD corrigidos pelo laboratório), medidor cadastrado no CSD errado, medidor agendado errado, data/horário de agendamento diferente do documento, medidor não agendado no ato da inspeção, documento de inspeção importado pelo laboratório, ausência de registro fotográfico e registro fotográfico com baixa qualidade. Confira o valor informado no cadastro e o valor corrigido."
